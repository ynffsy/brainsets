...
def main():
    ...
    cursor_timestamp_domains = Interval(
        start=cursor.timestamps - 0.029, 
        end=cursor.timestamps + 0.001,
    )
    ...
    successful_trial_intervals = Interval(
        start=successful_trials.start, 
        end=successful_trials.end,
    )

    successful_cursor_timestamp_domains = cursor_timestamp_domains.select_by_interval(successful_trial_intervals)


    train_intervals, valid_intervals, test_intervals = successful_cursor_timestamp_domains.split(

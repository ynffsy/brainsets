...
configfile: f"environments/{local_env}.yaml"
...
module allen_brain_observatory_calcium_module:
    snakefile: "brainsets/allen_brain_observatory_calcium/Snakefile"
    config: config
...
module allen_natural_movie_calcium_module:
    snakefile: "brainsets/allen_natural_movie_calcium/Snakefile"
    config: config
...
module allen_visual_behavior_neuropixels_module:
    snakefile: "brainsets/allen_visual_behavior_neuropixels/Snakefile"
    config: config
...
module gillon_richards_responses_2023_module:
    snakefile: "brainsets/gillon_richards_responses_2023/Snakefile"
    config: config
...
module perich_miller_population_2018_module:
    snakefile: "brainsets/perich_miller_population_2018/Snakefile"
    config: config
...
module evenchen_shenoy_structure_2019_module:
    snakefile: "brainsets/evenchen_shenoy_structure_2019/Snakefile"
    config: config
...
module willett_shenoy_module:
    snakefile: "brainsets/willett_shenoy/Snakefile"
    config: config
...
module odoherty_sabes_nonhuman_2017_module:
    snakefile: "brainsets/odoherty_sabes_nonhuman_2017/Snakefile"
    config: config
...
module churchland_shenoy_neural_2012_module:
    snakefile: "brainsets/churchland_shenoy_neural_2012/Snakefile"
    config: config
...
module mc_maze_small_module:
    snakefile: "brainsets/mc_maze_small/Snakefile"
    config: config
...
module bouchard_chang_module:
    snakefile: "brainsets/bouchard_chang/Snakefile"
    config: config
...
module flint_slutzky_accurate_2012_module:
    snakefile: "brainsets/flint_slutzky_accurate_2012/Snakefile"
    config: config
...
module willett_henderson_speech_2023_module:
    snakefile: "brainsets/willett_henderson_speech_2023/Snakefile"
    config: config
...
module orsborn_lab_ecog_reaching_2024_module:
    snakefile: "brainsets/orsborn_lab_ecog_reaching_2024/Snakefile"
    config: config
...
module yu_smith_selective_2022_module:
    snakefile: "brainsets/yu_smith_selective_2022/Snakefile"
    config: config
